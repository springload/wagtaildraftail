...
class WagtailLinkSource extends WagtailModalSource {
    constructor(props) {
        super(props);
    ...
    buildInitialUrl(entity, openAtParentId, canChooseRoot, pageTypes) {
    ...
    componentDidMount() {
        ...
        const { url, urlParams } = this.buildInitialUrl(entity, openAtParentId, canChooseRoot, pageTypes);
...
export default WagtailLinkSource;
